...
# Model Parmeters
#
# Peter Turney, December 6, 2019
#
# Set various parameters for running experiments
#
#
#
# Rule name (omit the rule file suffix ".rule")
#
rule_group = "Group-2"
rule_defn = "B35-S247"
#
rule_name = rule_group + "-" + rule_defn
#
# Directory for log files
#
log_directory = "../Experiments/exper3/" + \
  rule_group + "/" + rule_defn
#
#
# Type of experiment:
#
